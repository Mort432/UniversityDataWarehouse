...
namespace UniversityDataWarehouse.Apps.Wpf.ViewModels
{
    public class ModulesViewModel : FactChartViewModelBase<ModuleFact>
    {
        ...
        public ModulesViewModel(IModuleFactService moduleFactService, ICourseDimService courseDimService) :
        ...
        public CourseDim CourseDim
        {
            ...
            set
            {
                ...
                Expression<Func<ModuleFact, bool>> expression = x => x.CourseDimId == _courseDim.Id;
