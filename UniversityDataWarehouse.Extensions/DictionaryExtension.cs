...
namespace UniversityDataWarehouse.Extensions
{
    public static class DictionaryExtension
    {
        ...
        public static IEnumerable<ObservablePoint> AsObservablePoints<TKey>(this IDictionary<TKey, int> dictionary,
        ...
        public static IEnumerable<ObservablePoint> AsObservablePoints<TValue>(this IDictionary<int, TValue> dictionary,
